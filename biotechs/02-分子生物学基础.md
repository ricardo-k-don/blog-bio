...
2. not italicized
   ...
   - _DnaA⁻_ the protein produced by the *dnaA* gene
   - _LeuA⁻_ the phenotype of a *leuA* mutant
...
- IPTG 与自然的 _β_-半乳糖苷酶相似，且不能被酶分解，它的浓度在实验中不会改变。能在缺乏*lacY*基因下而有效地被运送。
- 半乳糖苷键中用硫代替了氧，失去了水解活性，但硫代半乳糖苷和同源的氧代化合物与酶位点的亲和力相同，IPTG 虽不为 _β_-半乳糖苷酶所识别，但它是 lac 基因簇十分有效的诱导物；
- X-gal（5-溴 -4-录 -3-吲哚-_β_-半乳糖苷）亦为一种人工化学合成的半乳糖苷，可被 _β_-半乳糖苷酶水解产生兰色化合物，因此可用作 β－半乳糖苷酶活性的指示剂；IPTG 和 X-gal 都被广泛应用在分子生物学和基因工程的工作中；
